...
const BOT_TOKEN = "1920905087:AAG_xCvsdjxVu8VUDt9s4JhD22ND-UIJttQ";
const BOT_WEBHOOK = "/endpoint";
const BOT_SECRET = "ccgnimex";
const BOT_OWNER = 784985038;
const BOT_CHANNEL = -1002454302023;
const SIA_SECRET = "8KYybRW2";
